...
export default class ChatgptService extends Base {
     ...
     * @return string
     */
    static async general_with_cache_bak(ctx, text, uniq_id) {
        // 获取会话
        let option = {
            timeoutMs: AI.timeout_second * 1000,
        }
